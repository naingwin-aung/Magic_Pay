...
@section('content')
    <div class="scan_and_pay_confirm mb-5">
        <div class="card shadow">
            <div class="card-body"> 
                ...
                <form action="{{route('scanAndPay.complete')}}" method="POST" id="complete-form">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary float-right mt-3 complete-btn">Confirm</button>
                </form>
            </div>
        </div>
    </div>
